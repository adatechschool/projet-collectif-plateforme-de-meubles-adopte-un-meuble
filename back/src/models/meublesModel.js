...
//Requête pour obtenir tous les meubles de la BDD :
const getMeubles = async (req, res) => {
  const { data, error } = await supabase.from("Meuble").select("*");
...
//Exporter la fonction getMeubles pour pouvoir l'utiliser dans le fichier meublesControllers.js
module.exports = { getMeubles };
